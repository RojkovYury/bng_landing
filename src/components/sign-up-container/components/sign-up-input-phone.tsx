...
interface SingUpInputPhoneProps {
  value: string;
...
export default function SingUpInputPhone({ value, setValue, sx, errorInput, setErrorInput, disabled }: SingUpInputPhoneProps) {
    ...
    <>
      <Input
        ...
        sx={{
          ...
          color: !disabled ? '#2F3134' : '#2f31345c',
